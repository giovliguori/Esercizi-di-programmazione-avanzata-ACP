...
class DispatcherSkeleton(DispatcherService):
    ...
    In questo caso, "attivo" la delega, ovvero:
        ...
        - Utilizza un riferimento a dispatcher_service che farà riferimento a sua volta a chi implementa veramente DispatcherService, 
    ...
    def getCmd(self):
        # ATTENZIONE: fare il return di getCmd()!!!
